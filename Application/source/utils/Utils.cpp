...
namespace Utils {
    ...
    std::string formatHexString(const u64 value) {
        std::stringstream ss;
    ...
    std::string lastPlayedToString(u64 t) {
    ...
    std::string playtimeToString(u64 s) {
        if (s == 0) {
    ...
    std::string playtimeToPlayedForString(u64 s) {
        if (s < 60) {
    ...
    std::string playtimeToTotalPlaytimeString(u64 s) {
        if (s == 0) {
