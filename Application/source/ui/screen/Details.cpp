...
namespace Screen {
    ...
    void Details::updateSessions() {
        ...
        u64 s = Utils::Time::getTimeT(this->app->time());
        // Minus one second so end time is 11:59pm and not 12:00am next day
        u64 e = Utils::Time::getTimeT(Utils::Time::increaseTm(this->app->time(), c)) - 1;
