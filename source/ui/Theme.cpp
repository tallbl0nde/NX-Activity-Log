...
std::function<Aether::Colour(uint32_t)> Theme::highlightFunc() {
    ...
    return [h1, h2](uint32_t t) {
        ...
        col.r = h1.r + ((h2.r - h1.r) * (0.5 * sin(1.8 * M_PI * (t/1000.0)) + 0.5));
        col.g = h1.g + ((h2.g - h1.g) * (0.5 * sin(1.8 * M_PI * (t/1000.0)) + 0.5));
        col.b = h1.b + ((h2.b - h1.b) * (0.5 * sin(1.8 * M_PI * (t/1000.0)) + 0.5));
        col.a = h1.a + ((h2.a - h1.a) * (0.5 * sin(1.8 * M_PI * (t/1000.0)) + 0.5));
        return col;
    };
}
